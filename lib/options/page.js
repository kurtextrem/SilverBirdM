...
$(function() {
  ...
  if(tweetManager && Array.isArray(tweetManager.shortener.services)) {
  ...
  if(tweetManager && tweetManager.ready) {
    ...
    $selectTrendingRegions.append($("<option>").val("1").text(chrome.i18n.getMessage('worldwide')));
  }
